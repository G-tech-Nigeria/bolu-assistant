-- Fix Dev Roadmap Tables and Data
...
INSERT INTO dev_roadmap_achievements (id, title, description, icon, requirement, category, points, order_index) 
SELECT * FROM (
    VALUES 
    ('first-hour', 'First Hour', 'Complete your first hour of study', '⏰', 'Study for 1 hour', 'milestone', 10, 1),
    ('first-day', 'First Day', 'Complete your first day of study', '📅', 'Study for 1 day', 'milestone', 50, 2),
    ('first-week', 'First Week', 'Complete your first week of study', '📆', 'Study for 7 days', 'milestone', 100, 3),
    ('first-month', 'First Month', 'Complete your first month of study', '🗓️', 'Study for 30 days', 'milestone', 500, 4),
    ('first-leetcode', 'First LeetCode', 'Solve your first LeetCode problem', '💻', 'Solve 1 LeetCode problem', 'coding', 25, 5),
    ('leetcode-10', 'LeetCode Beginner', 'Solve 10 LeetCode problems', '🎯', 'Solve 10 LeetCode problems', 'coding', 100, 6),
    ('leetcode-50', 'LeetCode Intermediate', 'Solve 50 LeetCode problems', '🏆', 'Solve 50 LeetCode problems', 'coding', 250, 7),
    ('leetcode-100', 'LeetCode Advanced', 'Solve 100 LeetCode problems', '👑', 'Solve 100 LeetCode problems', 'coding', 500, 8),
    ('first-project', 'First Project', 'Complete your first project', '🚀', 'Complete 1 project', 'project', 200, 9),
    ('project-5', 'Project Builder', 'Complete 5 projects', '🏗️', 'Complete 5 projects', 'project', 500, 10),
    ('project-10', 'Project Master', 'Complete 10 projects', '🎨', 'Complete 10 projects', 'project', 1000, 11),
    ('streak-7', 'Week Warrior', 'Maintain a 7-day study streak', '🔥', 'Study for 7 consecutive days', 'streak', 150, 12),
    ('streak-30', 'Month Master', 'Maintain a 30-day study streak', '🔥🔥', 'Study for 30 consecutive days', 'streak', 500, 13),
    ('streak-100', 'Century Club', 'Maintain a 100-day study streak', '🔥🔥🔥', 'Study for 100 consecutive days', 'streak', 1000, 14),
    ('hours-10', 'Dedicated Learner', 'Study for 10 hours', '📚', 'Study for 10 hours', 'time', 100, 15),
    ('hours-50', 'Serious Student', 'Study for 50 hours', '📖', 'Study for 50 hours', 'time', 250, 16),
    ('hours-100', 'Knowledge Seeker', 'Study for 100 hours', '🎓', 'Study for 100 hours', 'time', 500, 17),
    ('hours-500', 'Learning Legend', 'Study for 500 hours', '🧠', 'Study for 500 hours', 'time', 1000, 18),
    ('phase-1', 'Foundation Complete', 'Complete the Foundation phase', '🏁', 'Complete 1 phase', 'phase', 200, 19),
    ('phase-3', 'Halfway There', 'Complete 3 phases', '🎯', 'Complete 3 phases', 'phase', 500, 20),
    ('phase-6', 'Roadmap Complete', 'Complete all phases', '🏆', 'Complete all phases', 'phase', 1000, 21),
    ('roadmap-complete', 'Roadmap Master', 'Complete the entire development roadmap', '👑', 'Complete all phases, topics, and projects', 'milestone', 2000, 22),
    ('job-ready', 'Job Ready', 'Get your first developer job', '💼', 'Land your first developer job', 'milestone', 5000, 23),
    ('senior-developer', 'Senior Developer', 'Become a senior developer', '👑', 'Achieve senior developer status', 'milestone', 10000, 24)
) AS new_achievements(id, title, description, icon, requirement, category, points, order_index)
