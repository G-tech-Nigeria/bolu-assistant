...
export default function FocusTimerPage({}: FocusTimerPageProps) {
  ...
  const handleBack = () => {
    // Navigate back to the main dashboard without any URL parameters
    navigate('/dashboard')
  }

  const handleGoToDevRoadmap = () => {
    // Navigate to Dev Roadmap with log form open
    navigate('/dev-roadmap?openLogForm=true')
  }

  const handleGoToFocusHome = () => {
    // Navigate to Focus Home page
    navigate('/focus-home')
  }
  ...
  return (
    <>
      ...
      style={hasBackgroundImage && !hasMixedThemes ? { backgroundImage: `url(${getOptimizedImageUrl(currentThemeData.backgroundImage!)})` } : {}}
    >
